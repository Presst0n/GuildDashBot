using Discord;
using DiscordBot.Server.Bot.RaiderIOLibrary.Entities;
using DiscordBot.Server.Bot.RaiderIOLibrary.Entities.MythicPlus;
using System;
...
namespace DiscordBot.Server.Bot.Extensions
{
    public static class RaiderioExtensions
    {
        public static Embed GetEmbededGuildProgressMsg(this GuildRaidProgression raidProgression)
        {
            ...
            builder.AddField("Nyalotha:",
                $"Normal: {raidProgression.RaidInfo.NyalothaTheWakingCity.NormalBossesKilled}/8\n" +
                $"Heroic: {raidProgression.RaidInfo.NyalothaTheWakingCity.HeroicBossesKilled}/8\n" +
                $"Mythic: {raidProgression.RaidInfo.NyalothaTheWakingCity.MythicBossesKilled}/8\n", true);
        ...
        public static Embed GetEmbededCharacterMsg(this Character character)
        {
            ...
            builder.AddField("Nyalotha:", $"M: {character.GetRaidProgression.NyalothaTheWakingCity.MythicBossesKilled}/12\n" +
                $"H: {character.GetRaidProgression.NyalothaTheWakingCity.HeroicBossesKilled}/12", true);
            builder.WithColor(Color.DarkBlue);
            var output = builder.Build();
